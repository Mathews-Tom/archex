...
def produce_artifacts(
    ...
    *,
    ...
    """Run the full parse → import-resolve → chunk pipeline.

    Unified entry point for artifact production. Composes parse_repository()
    and build_chunks() into a single call that also produces dependency edges
    and retains source bytes.
